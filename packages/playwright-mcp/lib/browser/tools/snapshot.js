...
const elementSchema = import_mcpBundle.z.object({
  ...
  includeSnapshot: import_mcpBundle.z.boolean().optional().describe("Set to false to suppress the accessibility snapshot in the response. Saves tokens on intermediate actions when you already know the next step.")
});
